      ...
      <div className="relative z-10 container mx-auto px-4 py-32 flex items-center justify-center min-h-screen">
        ...
        >
          ...
          <p className="text-lg leading-relaxed my-8">
            Từ mạch nước ngầm tích tụ từ kỷ Creata muộn (cuối kỷ Phấn Trắng)
            trải qua hàng triệu năm trên cao nguyên Lâm Đồng. Nguồn nước của La
            Gougah được khai thác ở độ sâu hơn 250m của nguồn nước này, qua hệ
            thống xử lý nước hiện đại RO của Mỹ và hệ thống chiết rót tự động
            được nhập khẩu 100% từ Đài Loan, để trao đến người tiêu dùng sản
            phẩm nước uống đóng chai thanh khiết, an toàn và đảm bảo các thành
            phần tốt cho sức khoẻ.
          </p>
