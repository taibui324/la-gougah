...
export default function Footer() {
  return (
    <footer className="text-blue-900" style={{ background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.36) 0%, #82B3F6 100%)' }}>
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-1">
            <h4 className="text-lg font-medium mb-4">Tìm hiểu nước La Gougah</h4>
        ...
        <div className="border-t border-blue-400 mt-8 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-blue-800">Copyright © 2023 La Gougah Water</p>
