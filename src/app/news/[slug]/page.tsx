...
export default function NewsDetailPage() {
  ...
  // Sample news data - this should be the same as in news-section.tsx and news/page.tsx
    ...
    <>
      ...
      <section className="relative h-[50vh] w-full overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex flex-col items-center justify-center">
          <span className="text-sm text-blue-300 mb-3">{newsItem.date}</span>
          <h1 className="text-3xl md:text-5xl font-bold text-white text-center max-w-4xl">{newsItem.title}</h1>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div 
            ref={contentRef}
            className="max-w-3xl mx-auto transition-all duration-1000 opacity-0 translate-y-10"
          >
